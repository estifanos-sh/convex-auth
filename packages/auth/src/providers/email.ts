...
export interface EmailProviderConfig<Id extends string = "email"> {
 ...
 * ```
 */
export function email<const Id extends string = "email">(
  config: EmailProviderConfig<Id>,
): EmailConfig<AnyDataModel, Id> {
