...
export const authEnv = {
  ...
  AUTH_APPLE_KEY_ID: v.optional(v.string()),
  AUTH_APPLE_PRIVATE_KEY: v.optional(v.string()),
  AUTH_APPLE_TEAM_ID: v.optional(v.string()),
  ...
  AUTH_MICROSOFT_ID: v.optional(v.string()),
