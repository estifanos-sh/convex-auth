...
deployments, and installed `@estifanos-sh/convex-auth` version. Preserve unrelated
work.
...
Use `pnpx @estifanos-sh/convex-auth doctor` as one signal, not as a substitute for
